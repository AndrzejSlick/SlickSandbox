...
const EVENTS: Evt[] = [
  ...
  { delay: 1800, op: "replace", msg: { id: 1, kind: "ai", lines: [
    "Zlecenie ZLW01442 · CMR: kompletny",
    "Lieferschein: brak podpisu odbiorcy i pieczątki.",
  ]}},
  { delay: 400,  op: "add",     msg: { id: 2, kind: "cta",      text: "Pokaż dokument" } },
  { delay: 1000, op: "add",     msg: { id: 3, kind: "ai",       lines: ["Czy przypomnieć kierowcy o dosłaniu podpisanego dokumentu?"] } },
  { delay: 1400, op: "add",     msg: { id: 4, kind: "user",     text: "Tak, wyślij przypomnienie" } },
  { delay: 700,  op: "add",     msg: { id: 5, kind: "progress", text: "Wysyłam przypomnienie do kierowcy..." } },
  { delay: 3000, op: "reset" },
];
            ...
            if (msg.kind === "typing") {
              return (
                <div key={msg.id} className="chat-msg flex items-center gap-2 px-1">
                  ...
                  <p className="text-[13px] text-[#9333ea] tracking-[0.4px]">Weryfikuję dokumenty...</p>
                </div>
              );
            }
          })}
