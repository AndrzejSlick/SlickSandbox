...
import { ArrowUp, Fuel, Loader2 } from "lucide-react";
...
const EVENTS: Evt[] = [
  ...
  { delay: 1800, op: "replace", msg: { id: 1, kind: "ai", lines: [
    "TIR-248 · Tankowanie za ok. 120 km.",
    "Shell A1: 1.82 €/l · Orlen Autostrada: 1.71 €/l",
    "Oszczędność na tankowaniu: ok. 18 €.",
  ]}},
  { delay: 400,  op: "add",     msg: { id: 2, kind: "cta",      text: "Pokaż stacje" } },
  { delay: 1000, op: "add",     msg: { id: 3, kind: "ai",       lines: ["Czy skierować kierowcę do tańszej stacji Orlen?"] } },
  { delay: 1400, op: "add",     msg: { id: 4, kind: "user",     text: "Tak, wyślij wskazówki" } },
  { delay: 700,  op: "add",     msg: { id: 5, kind: "progress", text: "Wysyłam trasę do kierowcy..." } },
  { delay: 3000, op: "reset" },
];
            ...
            if (msg.kind === "typing") {
              return (
                <div key={msg.id} className="chat-msg flex items-center gap-2 px-1">
                  ...
                  <p className="text-[13px] text-[#9333ea] tracking-[0.4px]">Porównuję ceny paliwa...</p>
                </div>
              );
            }
          })}
