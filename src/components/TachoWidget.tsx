...
import { ArrowUp, Loader2, Map } from "lucide-react";
...
const EVENTS: Evt[] = [
  ...
  { delay: 1800, op: "replace", msg: { id: 1, kind: "ai", lines: [
    "Piotr Kowalski · Postój: 23 min · Zostało jazdy: 0h 45min",
    "Dostawa do Wallenhorst szac. o 16:50 — nie zdąży przed przerwą.",
  ]}},
  { delay: 400,  op: "add",     msg: { id: 2, kind: "cta",      text: "Pokaż trasę" } },
  { delay: 1000, op: "add",     msg: { id: 3, kind: "ai",       lines: ["Czy zaproponować wcześniejszy postój i powiadomić klienta?"] } },
  { delay: 1400, op: "add",     msg: { id: 4, kind: "user",     text: "Tak, zaproponuj postój i napisz do klienta" } },
  { delay: 700,  op: "add",     msg: { id: 5, kind: "progress", text: "Planuję postój i powiadamiam klienta..." } },
  { delay: 3000, op: "reset" },
];

export function TachoWidget() {
