...
const EVENTS: Evt[] = [
  ...
  { delay: 1800, op: "replace", msg: { id: 1, kind: "ai", lines: [
    "Nowe zlecenie z maila · logistics@firma.de",
    "Załadunek: Warszawa, 12.03 · Rozładunek: Frankfurt, 14.03",
    "Dane sparsowane i gotowe do importu.",
  ]}},
  { delay: 400,  op: "add",     msg: { id: 2, kind: "cta",      text: "Sprawdź zlecenie" } },
  { delay: 1000, op: "add",     msg: { id: 3, kind: "ai",       lines: ["Czy dodać zlecenie do systemu i przypisać kierowcę?"] } },
  { delay: 1400, op: "add",     msg: { id: 4, kind: "user",     text: "Tak, dodaj do systemu" } },
  { delay: 700,  op: "add",     msg: { id: 5, kind: "progress", text: "Dodaję zlecenie i przypisuję kierowcę..." } },
  { delay: 3000, op: "reset" },
];
            ...
            if (msg.kind === "typing") {
              return (
                <div key={msg.id} className="chat-msg flex items-center gap-2 px-1">
                  ...
                  <p className="text-[13px] text-[#9333ea] tracking-[0.4px]">Parsuję zlecenie...</p>
                </div>
              );
            }
          })}
